...
-- Generated by build_cooked_skin_paths.py --all from each weapon DA's cooked WeaponSkin
-- soft ref. Regenerate rather than hand-edit; an item missing here must never reach
-- GetAsset, which crashes on a package that does not exist.
local SKIN_CLASS = {
